...
slime = pygame.transform.scale(pygame.image.load('assets/enemy/slime/slime1.png'), (50, 50))
chest = pygame.transform.scale(pygame.image.load('assets/chest.png'), (50, 50))
